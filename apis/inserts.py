...
def create_product(seller_id = 1, seller_name="John Doe", product_name="Default Product", description="Default Description", price=0.0, tags = [], categories = [], session = None):
...
def create_review(customer_name="John Doe", review_text="Default Review", stars=5, product=None, session=None):
